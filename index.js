...
//
const BotName = 'BOT ./MauRivBot'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/47.5554/'; // Nama Instagramlu cok
const whatsapplu = '0857-8267-9468'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung Signal'; // Kapan bot lu aktif
